...
import { BellIcon, HomeIcon, ShipWheelIcon, UsersIcon, CodeIcon } from "lucide-react";
  ...
  return (
    <aside className="w-64 bg-base-200 border-r border-base-300 hidden lg:flex flex-col h-screen sticky top-0">
      ...
      <nav className="flex-1 p-4 space-y-1">
        ...
        <Link
          to="/developer"
          className={`btn btn-ghost justify-start w-full gap-3 px-3 normal-case ${currentPath === "/developer" ? "btn-active" : ""
            }`}
        >
